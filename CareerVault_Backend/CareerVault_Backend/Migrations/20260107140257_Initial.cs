        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoticePeriodInDays = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applicant_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobAdverts_Departments_DepartmentId1",
                        column: x => x.DepartmentId1,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobAdverts_JobLevels_JobLevelId",
                        column: x => x.JobLevelId,
                        principalTable: "JobLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobAdverts_OfficeLocations_OfficeLocationId",
                        column: x => x.OfficeLocationId,
                        principalTable: "OfficeLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobAdverts_Positions_PositionId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Titles_JobLevels_JobLevelId",
                        column: x => x.JobLevelId,
                        principalTable: "JobLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Titles_OfficeLocations_OfficeLocationId",
                        column: x => x.OfficeLocationId,
                        principalTable: "OfficeLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Titles_Positions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppliedByUserID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PositionId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PositionId1 = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JobApplications_AspNetUsers_AppliedByUserID",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JobApplications_Positions_PositionId1",
                        column: x => x.PositionId1,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeProfiles_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeProfiles_Titles_TitleId",
                        column: x => x.TitleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeProfiles_TitleId",
                table: "EmployeeProfiles",
                column: "TitleId");

            migrationBuilder.CreateIndex(
                name: "IX_JobAdverts_DepartmentId1",
                table: "JobAdverts",
                column: "DepartmentId1");

            migrationBuilder.CreateIndex(
                name: "IX_JobAdverts_JobLevelId",
                table: "JobAdverts",
                column: "JobLevelId");

            migrationBuilder.CreateIndex(
                name: "IX_JobAdverts_OfficeLocationId",
                table: "JobAdverts",
                column: "OfficeLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_JobAdverts_PositionId1",
                table: "JobAdverts",
                column: "PositionId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_AppliedByUserID",
                table: "JobApplications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_PositionId1",
                table: "JobApplications",
                column: "PositionId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Titles_JobLevelId",
                table: "Titles",
                column: "JobLevelId");

            migrationBuilder.CreateIndex(
                name: "IX_Titles_OfficeLocationId",
                table: "Titles",
                column: "OfficeLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Titles_PositionId",
                table: "Titles",
                column: "PositionId");
        }
